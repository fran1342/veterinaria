...
<script src="<?=base_url('resources/plugins/jquery/jquery.min.js');?>"></script>
    ...
    <script src="<?=base_url('resources/dist/js/demo/chart-area-demo.js');?>"></script>
    <script src="<?=base_url('resources/dist/js/demo/chart-pie-demo.js');?>"></script>
    ...
    <!-- Toast -->
    <script src="<?=base_url('resources/plugins/cute-alert-master/cute-alert.js');?>"></script>
